...
// NOTE: this must be registered after adminAuth is declared above (const
// isn't hoisted — registering it earlier in the file threw a
// "Cannot access 'adminAuth' before initialization" crash on boot).
